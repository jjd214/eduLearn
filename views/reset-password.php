            ...
            <div class="row justify-content-end">
              <div class="col-md-8">
                ...
                <form action="#" method="post">
                  ...
                  <!-- Repeat Password -->
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control" name="confirmnewPassword" id="floatingPassword" placeholder="confirmPassword" required>
                    <label for="floatingPassword">Confirm your new Password</label>
                  </div>

                  <!-- Log in btn -->
                  <input type="submit" value="Reset Password" class="mt-4 btn btn-block btn-primary col-md-12">
