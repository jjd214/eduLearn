<!--
    sa page nato gawa ka ng isang table para sa list ng mga uploaded video sa course,
    may action for sya edit button and delete button.
    Tas gawa ka naman ng form para mag upload ng video sa course. -->
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="forms-sample">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control border-primary" id="exampleInputUsername1" placeholder="Chapter Title" required>
                                                                            </div>
                                                                            <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="mt-2 mb-2">
                                                                                    <img src="/eduLearn/views/instructor/dashboard/uploads/placeholder.png" />
                                                                                </div>
